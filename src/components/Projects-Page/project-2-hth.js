                ...
                <section className="project-section background-hands-to-hear landing-section">
                    <div className="title-container col-12">
                        ...
                        <div className="buttons-container">
                            <a href="https://compassionate-fermi-44db9e.netlify.com/" target="_blank" rel="noopener noreferrer" className="action-2-button">Deployed App <i className="fas fa-hands"></i></a>
